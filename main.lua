...
local MISC = Window:CreateTab("Misc", 7733765224)
...
local ABOUT = Window:CreateTab("About", 7734110220)
ABOUT:CreateSection"Informations"

ABOUT:CreateParagraph({Title = "Executor: ", Content = getexploit()})
ABOUT:CreateLabel"Version: 1.0.0"
ABOUT:CreateLabel"Made By: Stephen Heathcliff"

ABOUT:CreateSection"Others"
       ...
       if request then
	   			request({
	   				...
	   				Body = HttpService:JSONEncode({
	   					...
	   					args = {code = "PdwEYHhS7g"}
	   				})
	   			})
        else
        Rayfield:Notify({
            Title = "Sorry!",
            Content = "Your executor can't support opening links.",
            Duration = 4,
            Image = "7743878857"
       })
	   end
